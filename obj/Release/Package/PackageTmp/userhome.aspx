...
<body>
	...
	<div class="container">
		...
		<%--	<label id="usrlbl" runat="server" class="mr-lg-4 mr-2" style="color:white;font-size:20px;"></label>--%>
			<ul class="menu mt-md-2 ml-auto">
				<li class="mr-lg-4 mr-2 active"><a href="userhome.aspx">Home</a></li>
				<li class="mr-lg-4 mr-2"><a href="addcomp.aspx">Lodge Complaint</a></li>
				<li class="mr-lg-4 mr-2"><a href="mycomp.aspx">My Complaints</a></li>
				<li class="mr-lg-4 mr-2"><a href="guide.aspx">Guidelines</a></li>
				<li class="mr-lg-4 mr-2"><a href="contact.aspx">Contact Us</a></li>
	...
	<div class="csslider infinity" id="slider1">
		...
		<div class="container" style="margin-top:15%">
							<div class="row">
								<div class="col-sm-6">
							<a href="addcomp.aspx" >
								<img src="images/comp.png" style="width:30%;height:50%;margin-left:30%"/>
									<label id="lbl1" runat="server" style="color:white;font-size:20px;" >Lodge Complaint</label>
 							</a>
								</div>
								<div class="col-sm-6">
							<a href="mycomp.aspx" >
								<img src="images/view.png" style="width:30%;height:50%;margin-left:30%"/>
									<label id="lbl2" runat="server" style="color:white;font-size:20px;" >View Status</label>
								</a>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-6">
							<a href="guide.aspx" >
								<img src="images/guide.png" style="width:30%;height:50%;margin-left:30%"/>
								<label id="lbl3" runat="server" style="color:white;font-size:20px;" >Guidelines</label>
								</a>
								</div>
								<div class="col-sm-6">
								<a href="contact.aspx" >
								<img src="images/cont.png" style="width:30%;height:50%;margin-left:30%"/>
								<label id="lbl4" runat="server" style="color:white;font-size:20px;" >Contact Us</label>
									</a>
								</div>
							</div>
			...
			<%--<div class="row">
								<div class="col-sm-6">
								<a href="mycomp.aspx" >
								<img src="images/comph.png" style="width:30%;height:50%;margin-left:30%"/>
									<label id="lbl5" runat="server" style="color:white;font-size:20px;" >Complaint History</label>
									</a>
								</div>
							
								<div class="col-sm-6">
								<a href="viewloc.aspx" >
								<img src="images/map.png" style="width:30%;height:50%;margin-left:30%"/>
									<label id="lbl6" runat="server" style="color:white;font-size:20px;" >Map</label>
								</a>
								</div>
