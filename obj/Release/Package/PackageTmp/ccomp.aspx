<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ccomp.aspx.cs" Inherits="CropPrediction.ccomp" %>
...
<body>
   ...
   <section class="contact py-5">
	<div class="container py-sm-3">
		<h3 class="heading mb-sm-5 mb-4 text-center"> Unresolved Complaints</h3>
        ...
        <asp:TemplateField HeaderText="Complaint Image">
            ...
            <asp:CommandField ShowDeleteButton="true" HeaderText="Action" ButtonType="Button" SelectText="Reply" DeleteText="Reply"/>
            </Columns>
