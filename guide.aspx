<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="guide.aspx.cs" Inherits="CropPrediction.guide" %>
...
<body>
    ...
    <header style="background-color:#84a4f5;">
	<div class="container">
		<!-- nav -->
		<nav class="py-4 d-lg-flex">
			<div id="logo">
				<!--<h1> <a href="index.html"><span class="fa fa-leaf"></span> Smart City</a></h1>-->
			<h1> <a href="index.aspx"><img src="images/spk.jpg" style="width:50px;height:50px;" /><span style="font-weight: 900;"><b style="font-weight: bolder;color:#2d6987 "> E-Grievance</b></span></a></h1>
			</div>
				...
				<div class="banner-top">
					<div class="overlay">
						<div class="container">
							...
							<p  style="color:white;font-size:20px;">Misuse of the application will lead to blockage of your account</p>
							<p style="color:white;font-size:20px;">Image will be verified before processing</p>
							<p style="color:white;font-size:20px;">All compalints will be verified before processing</p>
							</div>
						</div>
					</div>
				</div>
