<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="CropPrediction.contact" %>
				...
				<div class="banner-top">
					<div class="overlay">
						<div class="container">
							...
							<p style="color:white;font-size:20px;">Contact : Mysuru City corporation</p>
							</div>
						</div>
					</div>
				</div>
