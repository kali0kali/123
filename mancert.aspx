<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mancert.aspx.cs" Inherits="CropPrediction.mancert" %>
...
<body>
	...
	<div class="container">
		...
		<nav class="py-4 d-lg-flex">
			...
			<ul class="menu mt-md-2 ml-auto">
				...
				<li class="mr-lg-4 mr-2"><a href="mancert.aspx">Manage Certificate</a></li>
   ...
   <section class="contact py-5">
	<div class="container py-sm-3">
		<h3 class="heading mb-sm-5 mb-4 text-center"> Manage Certificate</h3>
        ...
        <Columns>
            ...
            <asp:BoundField DataField="FromPerson" HeaderText="Name" SortExpression="FromPerson" />
