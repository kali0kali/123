<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewloc.aspx.cs" Inherits="CropPrediction.viewloc" %>
	...
	<div class="container">
		...
		<nav class="py-4 d-lg-flex">
			<div id="logo">
				...
				<h1> <a href="index.html"><img src="images/spk.jpg" style="width:50px;height:50px;" /><span style="font-weight: bold;"> E-Grievance</span></a>
			</div>
			...
			<ul class="menu mt-md-2 ml-auto">
				...
				<li class="mr-lg-4 mr-2"><a href="vrply.aspx">Messages</a></li>--%>
...
#map_canvas { height: 100% }
  ...
  <input runat="server" type="text" id="lat" visible="true" />
	<input runat="server" type="text" id="lon" visible="true" />
